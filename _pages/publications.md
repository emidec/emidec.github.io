...
<style>
#pub-filters{display:flex;flex-wrap:wrap;align-items:center;gap:.6em 1.4em;margin:1.2em 0 .4em;padding:.7em .9em;border:1px solid #e2e2e2;border-radius:8px;background:#fafafa;font-size:.85em}
#pub-filters .pub-filter-group{display:flex;align-items:center;gap:.5em}
#pub-filters .pub-filter-label{font-weight:700;text-transform:uppercase;letter-spacing:.04em;color:#666;font-size:.85em}
#pub-filters select{padding:.25em .5em;border:1px solid #ccc;border-radius:5px;background:#fff;font-size:1em}
#pub-filters .pub-tier-btn{cursor:pointer;padding:.3em .8em;border:1px solid #ccc;border-radius:20px;background:#fff;color:#333;font-size:1em;line-height:1.4}
...
{: data-topics="tml cyb" data-tier="top"}
...
{: data-topics="tml gen sdata" data-tier="top"}
...
[pdf](https://arxiv.org/pdf/2001.07157.pdf){: .btn--danger}{:target="_blank"}
...
14th International AAAI Conference on Web and Social Media (ICWSM 2020)  
[pdf](https://arxiv.org/pdf/1901.05997.pdf){: .btn--danger}{:target="_blank"}
{: data-topics="cyb" data-tier="top"}

A. Mittos, S. Zannettou, J. Blackburn, and E. De Cristofaro  
**"And We Will Fight For Our Race! A Measurement Study of Genetic Testing Conversations on Reddit and 4chan**  
14th International AAAI Conference on Web and Social Media (ICWSM 2020)  
[pdf](https://arxiv.org/pdf/1901.09735.pdf){: .btn--danger}{:target="_blank"} [video](https://www.youtube.com/watch?v=qTLKspE36kY){: .btn--danger}{:target="_blank"}  
...
{: data-topics="cyb gen" data-tier="top"}
...
[pdf](https://arxiv.org/pdf/1804.10982.pdf){: .btn--danger}{:target="_blank"}
...
[pdf](https://arxiv.org/pdf/1803.03448.pdf){: .btn--danger}{:target="_blank"}
...
[pdf](https://eprint.iacr.org/2018/344.pdf){: .btn--danger}{:target="_blank"}
{: data-topics="pso"}
...
[pdf](https://eprint.iacr.org/2017/770.pdf){: .btn--danger}{:target="_blank"}
{: data-topics="gen"}
...
[pdf](https://arxiv.org/pdf/1801.10396.pdf){: .btn--danger}{:target="_blank"}
{: data-topics="cyb" data-tier="top"}
...
[pdf](https://arxiv.org/pdf/1610.03452){: .btn--danger}{:target="_blank"} [blog](https://www.benthamsgaze.org/2016/11/16/a-longitudinal-measurement-study-of-4chans-politically-incorrect-forum-and-its-effect-on-the-web/){: .btn--danger}{:target="_blank"}  
...
[pdf](https://arxiv.org/pdf/1605.03772.pdf){: .btn--danger}{:target="_blank"}
...
[pdf](https://arxiv.org/pdf/1510.04083.pdf){: .btn--danger}{:target="_blank"}
...
[pdf](https://eprint.iacr.org/2015/949.pdf){: .btn--danger}{:target="_blank"}
...
[pdf](https://arxiv.org/pdf/1502.05337){: .btn--danger}{:target="_blank"}
{: data-topics="tml"}
...
[pdf](https://arxiv.org/pdf/1412.2433){: .btn--danger}{:target="_blank"}


L. Onwuzurike and E. De Cristofaro  
**Danger is my middle name: Experimenting with SSL Vulnerabilities in Android Apps**  
8th ACM Conference on Security and Privacy in Wireless and Mobile Networks (WiSec 2015)  
[pdf](https://arxiv.org/pdf/1505.00589){: .btn--danger}{:target="_blank"}
...
[pdf](https://arxiv.org/pdf/1402.3401){: .btn--danger}{:target="_blank"}  
...
[pdf](http://eprint.iacr.org/2013/620.pdf){: .btn--danger}{:target="_blank"}
...
[pdf](https://arxiv.org/pdf/1211.5183.pdf){: .btn--danger}{:target="_blank"}
...
[pdf](http://eprint.iacr.org/2012/054.pdf){: .btn--danger}{:target="_blank"} [code](https://emilianodc.com/code/psi_edc_v1.1.tgz){: .btn--danger}{:target="_blank"}
{: data-topics="pso"}
...
[pdf](http://eprint.iacr.org/2011/640){: .btn--danger}{:target="_blank"}
{: data-tier="top"}
...
[pdf](https://arxiv.org/pdf/1110.2478.pdf){: .btn--danger}{:target="_blank"}  
...
{: data-topics="pso gen" data-tier="top"}
...
[pdf](https://arxiv.org/pdf/1003.5510.pdf){: .btn--danger}{:target="_blank"} [code](http://code.google.com/p/ephpub){: .btn--danger}{:target="_blank"}


E. De Cristofaro, Y. Lu, G. Tsudik  
**Efficient Techniques for Privacy-preserving Sharing of Sensitive Information**  
4th International Conference on Trust and Trustworthy Computing (TRUST 2011)  
[pdf](http://eprint.iacr.org/2011/113){: .btn--danger}{:target="_blank"}


E. De Cristofaro, M. Manulis, B. Poettering  
**Private Discovery of Common Social Contacts**  
9th International Conference on Applied Cryptography and Network Security (ACNS 2011)  
[pdf](http://eprint.iacr.org/2011/026){: .btn--danger}{:target="_blank"}
...
[pdf](https://eprint.iacr.org/2011/041.pdf){: .btn--danger}{:target="_blank"}
...
[pdf](http://eprint.iacr.org/2010/220){: .btn--danger}{:target="_blank"}
{: data-topics="pso"}
...
[pdf](http://eprint.iacr.org/2010/469){: .btn--danger}{:target="_blank"}
{: data-topics="pso"}
...
[pdf](https://arxiv.org/pdf/1003.3242.pdf){: .btn--danger}{:target="_blank"}  
...
[pdf](http://eprint.iacr.org/2009/491.pdf){: .btn--danger}{:target="_blank"} [code](https://emilianodc.com/code/psi_edc_v1.1.tgz){: .btn--danger}{:target="_blank"}  
{: data-topics="pso"}
...
[pdf](https://emilianodc.com/PAPERS/PETS09.pdf){: .btn--danger}{:target="_blank"}
{: data-tier="top"}
...
[pdf](https://arxiv.org/pdf/0901.1095.pdf){: .btn--danger}{:target="_blank"}
...
[pdf](https://arxiv.org/pdf/0905.2158.pdf){: .btn--danger}{:target="_blank"}
...
[pdf](http://people.na.infn.it/~galdi/ABSTRACTS/esorics08.pdf){: .btn--danger}{:target="_blank"}
...
<p id="pub-tier-note" markdown="0"><span class="pub-note-star">[*]</span><strong>Top-Tier</strong> refers to venues listed as the &ldquo;most selective&rdquo; in Computer Science as per <a href="https://csrankings.org" target="_blank" rel="noopener">csrankings.org</a>, plus the top specialized venues in Computational Social Science (ICWSM and CSCW) and in Privacy Technologies (PETS).</p>
...
(function(){
  ...
  function init(){
    ...
    if(!root) return;
    var content = root.parentNode || document;
    var pubs = Array.prototype.slice.call(content.querySelectorAll('p')).filter(function(p){
      return p.querySelector('strong') && p.id!=='pub-tier-note';
    });
    ...
    pubs.forEach(function(p){
      ...
      /* Year from the last "(... YEAR)" parenthetical on the venue line. */
      var re=/\(([^)]*?((?:19|20)\d{2}))\)/g, m, last=null;
      while((m=re.exec(venue))!==null){ last=m; }
      var year = last ? last[2] : ((venue.match(/(?:19|20)\d{2}/g)||[]).slice(-1)[0] || '');

      p.setAttribute('data-year', year);
      if(year) years[year]=true;
    });

    var sel = document.getElementById('pub-year');
  ...
  function initTopBtn(){
    var btn=document.getElementById('pub-top-btn');
    if(!btn) return;
    ...
    function toggle(){ btn.style.display = sy() > 300 ? 'inline-flex' : 'none'; }
    window.addEventListener('scroll', toggle, {passive:true});
    document.addEventListener('scroll', toggle, {passive:true});
    toggle();
  }

  function boot(){ try{ init(); }catch(e){} initTopBtn(); }
